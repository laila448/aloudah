...
<div class="row row-sm">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('generateReport') }}" method="post" autocomplete="off">
                    {{ csrf_field() }}
                    <div class="form-group">
                    <label for="start_date">اسم السائق:</label>
                    <input type="string" class="form-control" name="name" id="name" required>
                    </div>
                    <div class="form-group">
